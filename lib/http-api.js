...
class MatrixHttpApi {
  ...
  authedRequest(callback, method, path, queryParams, data, opts // number is legacy
    ...
    requestPromise.catch(err => {
      ...
      if (err.errcode == 'M_UNKNOWN_TOKEN' && !((_requestOpts = requestOpts) !== null && _requestOpts !== void 0 && _requestOpts.inhibitLogoutEmit)) {
  ...
  request(callback, method, path, queryParams, data, opts) {
    ...
    const prefix = (_opts$prefix = opts === null || opts === void 0 ? void 0 : opts.prefix) !== null && _opts$prefix !== void 0 ? _opts$prefix : this.opts.prefix;
    ...
    const resetTimeout = () => {
      if (localTimeoutMs) {
        ...
        timeoutId = callbacks.setTimeout(function () {
          ...
          timedOut = true;
          (_req = req) === null || _req === void 0 ? void 0 : (_req$abort = _req.abort) === null || _req$abort === void 0 ? void 0 : _req$abort.call(_req);
...
function requestCallback(defer, userDefinedCallback, onlyData = false, bodyParser) {
  return function (err, response, body) {
    ...
    if (err) {
      defer.reject(err);
      userDefinedCallback === null || userDefinedCallback === void 0 ? void 0 : userDefinedCallback(err);
    } else if (onlyData) {
      defer.resolve(data);
      userDefinedCallback === null || userDefinedCallback === void 0 ? void 0 : userDefinedCallback(null, data);
    } else {
      const res = {
      ...
      defer.resolve(res);
      userDefinedCallback === null || userDefinedCallback === void 0 ? void 0 : userDefinedCallback(null, res);
    }
  };
}
/**
...
class MatrixError extends Error {
  ...
  constructor(errorJson = {}) {
    ...
    (0, _defineProperty2.default)(this, "httpStatus", void 0);
