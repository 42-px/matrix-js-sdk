...
import { ClientEvent, IKeysUploadResponse, IUploadKeySignaturesResponse, MatrixClient, SessionStore } from "../client";
...
export declare class Crypto extends TypedEventEmitter<CryptoEvent, CryptoEventHandlerMap> {
     ...
     */
    constructor(baseApis: MatrixClient, sessionStore: SessionStore, userId: string, deviceId: string, clientStore: IStore, cryptoStore: CryptoStore, roomList: RoomList, verificationMethods: Array<keyof typeof defaultVerificationMethods | typeof VerificationBase>);
    /**
