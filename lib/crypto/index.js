...
Object.keys(olmlib).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (Object.prototype.hasOwnProperty.call(_exportNames, key)) return;
  if (key in exports && exports[key] === olmlib[key]) return;
...
var _Channel = require("./verification/request/Channel");
