...
function isRoomSharedHistory(room) {
  ...
  const visibilityEvent = room === null || room === void 0 ? void 0 : (_room$currentState = room.currentState) === null || _room$currentState === void 0 ? void 0 : _room$currentState.getStateEvents("m.room.history_visibility", ""); // NOTE: if the room visibility is unset, it would normally default to
  // "world_readable".
...
class MegolmDecryption extends _base.DecryptionAlgorithm {
  ...
  async retryDecryption(senderKey, sessionId) {
    ...
    return !((_this$pendingEvents$s = this.pendingEvents[senderKey]) !== null && _this$pendingEvents$s !== void 0 && _this$pendingEvents$s.has(sessionId));
  }
