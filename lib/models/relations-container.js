...
class RelationsContainer {
  ...
  getChildEventsForEvent(eventId, relationType, eventType) {
    var _this$relations$event, _this$relations$event2;

    return (_this$relations$event = this.relations[eventId]) === null || _this$relations$event === void 0 ? void 0 : (_this$relations$event2 = _this$relations$event[relationType]) === null || _this$relations$event2 === void 0 ? void 0 : _this$relations$event2[eventType];
  }

  getAllChildEventsForEvent(parentEventId) {
    var _this$relations$paren;

    const relationsForEvent = (_this$relations$paren = this.relations[parentEventId]) !== null && _this$relations$paren !== void 0 ? _this$relations$paren : {};
    const events = [];
