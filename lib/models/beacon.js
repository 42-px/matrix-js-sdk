...
class Beacon extends _typedEventEmitter.TypedEventEmitter {
  ...
  monitorLiveness() {
    ...
    } else if (((_this$_beaconInfo3 = this._beaconInfo) === null || _this$_beaconInfo3 === void 0 ? void 0 : _this$_beaconInfo3.timestamp) > Date.now()) {
      var _this$beaconInfo;

      // beacon start timestamp is in the future
      // check liveness again then
      this.livenessWatchTimeout = setTimeout(() => {
        this.monitorLiveness();
      }, ((_this$beaconInfo = this.beaconInfo) === null || _this$beaconInfo === void 0 ? void 0 : _this$beaconInfo.timestamp) - Date.now());
    }
  }
  /**
  ...
  checkLiveness() {
    var _this$_beaconInfo4, _this$_beaconInfo5, _this$_beaconInfo6, _this$_beaconInfo7, _this$_beaconInfo8;
    ...
    const startTimestamp = ((_this$_beaconInfo4 = this._beaconInfo) === null || _this$_beaconInfo4 === void 0 ? void 0 : _this$_beaconInfo4.timestamp) > Date.now() ? ((_this$_beaconInfo5 = this._beaconInfo) === null || _this$_beaconInfo5 === void 0 ? void 0 : _this$_beaconInfo5.timestamp) - 360000
    /* 6min */
    : (_this$_beaconInfo6 = this._beaconInfo) === null || _this$_beaconInfo6 === void 0 ? void 0 : _this$_beaconInfo6.timestamp;
    this._isLive = ((_this$_beaconInfo7 = this._beaconInfo) === null || _this$_beaconInfo7 === void 0 ? void 0 : _this$_beaconInfo7.live) && isTimestampInDuration(startTimestamp, (_this$_beaconInfo8 = this._beaconInfo) === null || _this$_beaconInfo8 === void 0 ? void 0 : _this$_beaconInfo8.timeout, Date.now());
