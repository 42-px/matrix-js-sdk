...
exports.RoomEvent = exports.Room = exports.NotificationCountType = exports.KNOWN_SAFE_ROOM_VERSION = void 0;
...
class Room extends _typedEventEmitter.TypedEventEmitter {
  ...
  getEventReadUpTo(userId, ignoreSynthesized = false) {
    var _publicReadReceipt$da, _privateReadReceipt$d, _ref, _privateReadReceipt$e;
    ...
    if (!comparison) comparison = (publicReadReceipt === null || publicReadReceipt === void 0 ? void 0 : (_publicReadReceipt$da = publicReadReceipt.data) === null || _publicReadReceipt$da === void 0 ? void 0 : _publicReadReceipt$da.ts) - (privateReadReceipt === null || privateReadReceipt === void 0 ? void 0 : (_privateReadReceipt$d = privateReadReceipt.data) === null || _privateReadReceipt$d === void 0 ? void 0 : _privateReadReceipt$d.ts); // The public receipt is more likely to drift out of date so the private
    // one has precedence
    ...
    return comparison < 0 ? privateReadReceipt === null || privateReadReceipt === void 0 ? void 0 : privateReadReceipt.eventId : publicReadReceipt === null || publicReadReceipt === void 0 ? void 0 : publicReadReceipt.eventId;
  }
  /**
